...
void testInsert(){
    list = sllInsert(list, 10, "Gestrudes");
    list = sllInsert(list, 3, "Antonio");
    list = sllInsert(list, 5, "Jose");
    list = sllInsert(list, 30, "Gustavo");
    list = sllInsert(list, 1, "Orlando Marinheiro");
    sllPrint(list, stdout);
    if(sllExists(list, 3)) {printf("Aluno encontrado!");} else{printf("Aluno não encontrado!");}
