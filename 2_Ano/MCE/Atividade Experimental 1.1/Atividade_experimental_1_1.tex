...
\newlist{paragrafoenum}{itemize}{1}
\setlist[paragrafoenum,1]{label=\textbullet}
...
%%%%%% RESUMO %%%%%%
\begin{abstract}
Esta atividade laboratorial tem como objetivos determinar a velocidade inicial do projétil através das equações do movimento, verificar a dependência do alcance com o ângulo de lançamento e determinar a velocidade inicial do projétil utilizando um pêndulo balístico. Para a execução da atividade foi-nos fornecido um lançador de projéteis, dois sensores de passagem, um sensor de impacto, uma esfera metálica, uma fita métrica, papel químico e papel milimétrico. O processo foi divido em três partes, sendo realizado em aulas diferentes. Na Parte A, montamos o equipamento onde fixamos a base, ligamos o sistema de controlo, posicionamos os sensores e medimos a distância entre eles. De seguida, preparamos o LP para SHORT RANGE(GLOSSARIO) e configuramos o sistema de controlo. Disparamos o LP e registamos o tempo. Repetimos o procedimento três vezes, verificando a horizontalidade do LP. Na Parte B, fixamos a base à mesa, inclinando o LP a 30 graus. Posicionamos o alvo a uma distância apropriada e carregamos o LP para SHORT RANGE. Disparamos o LP e de seguida registamos o alcance (x) e o ângulo de lançamento (θ) em três repetições. Repetimos os passos anteriores para ângulos de 34°, 38°, 40° e 43°. Medimos com precisão a altura (yi) em relação à mesa em que a esfera é lançada. Na Parte C, medimos as massas do projétil (m), do pêndulo (M) para além do seu comprimento (l). Carregamos o LP para tiro curto na posição "SHORT RANGE" e efetuamos um disparo medindo o ângulo máximo (α) atingido pelo pêndulo. Repetimos o passo anterior mais duas (VER O NUM DE VEZES) vezes para obter medições adicionais.
FAZER RESUMO NO FINAL DO TRABALHO\\
\end{abstract}
...
\begin{figure}[H]
\centering
\includegraphics[scale=1]{fotos/3 partes do projeto.png}
\caption{As três fases da atividade experimental}\cite{blackcapa} %citar local da foto
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[scale=1.2]{fotos/parte A esquema.png}
...
\begin{figure}[H]
\centering
\includegraphics[scale=1.2]{fotos/Parte B esquema.png}
...
\begin{figure}[H]
\centering
\includegraphics[scale=1.2]{fotos/Parte C esquema.png}
